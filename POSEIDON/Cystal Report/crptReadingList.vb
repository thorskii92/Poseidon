...
Public Class crptReadingList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POSEIDON.crptReadingList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptReadingList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptReadingList = New crptReadingList()
        rpt.Site = Me.Site
        Return rpt
    End Function
