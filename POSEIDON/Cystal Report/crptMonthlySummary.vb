...
Public Class crptMonthlySummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POSEIDON.crptMonthlySummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptMonthlySummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptMonthlySummary = New crptMonthlySummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
