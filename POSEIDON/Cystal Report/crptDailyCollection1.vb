...
Public Class crptDailyCollection
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "crptDailyCollection.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POSEIDON.crptDailyCollection.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_txtRDNum() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrptDailyCollection
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptDailyCollection = New crptDailyCollection()
        rpt.Site = Me.Site
        Return rpt
    End Function
